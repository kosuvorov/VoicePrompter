# How to Read a Script Without Looking Like You're Reading
...
Voice-activated teleprompters like [VoicePrompter](https://voiceprompter.app) help here because the app pauses when you pause. You don't have to worry about "losing your place" if you take a breath. The text waits for you.
...
- Add slashes `/` where you want to pause
