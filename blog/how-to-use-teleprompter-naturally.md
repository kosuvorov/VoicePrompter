# How to Use a Teleprompter Naturally (So Nobody Knows You're Using One)
...
1. Eyes go to the screen → grab a phrase ("The most important thing")
2. Eyes move toward the camera → deliver the phrase ("The most important thing")
...
1. Set up your teleprompter with a short, familiar script (150–200 words).
2. Record yourself reading it.
3. Watch the recording. Look specifically for horizontal eye movement and reading pace.
