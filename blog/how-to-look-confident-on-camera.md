# How to Look Confident on Camera (Even When You're Not)
...
A voice-activated teleprompter like [VoicePrompter](https://voiceprompter.app) means the script is always in front of you, scrolling at your pace, giving you the next line exactly when you need it. The cognitive load of "what do I say next" is completely removed. You can put that energy into tone, eye contact, energy, and delivery.
...
Read more about this in [how to read a script without looking like you're reading](./how-to-read-script-without-looking-like-reading.md).
