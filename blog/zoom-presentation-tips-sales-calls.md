...
Here's the issue everyone has but nobody talks about in Zoom tip articles: where do your notes live during the call?

Options and why each is suboptimal:

**Paper notes on your desk.** You have to physically look down. The camera sees this clearly. You look unprepared or distracted.

**Second monitor with notes.** Your eyes go off to the side. The prospect can tell you're not looking at the camera. It reads as not paying attention.

**Notes in a browser tab.** You have to alt-tab, which means you lose your screen share or switch windows visibly.

**Trying to remember everything.** You forget key points, go off-track, or deliver the pricing wrong.

The actual solution: a teleprompter overlay that sits on top of your screen, visible only to you, and doesn't appear in your screen share.
...
It's invisible in Zoom. The window is excluded from macOS screen capture APIs. When you share your screen, your prospect sees your presentation. When they see your video, they see you. Nobody sees the script window.

It stays on top of everything. If you switch to full-screen slides in Keynote or put Zoom in full-screen mode, the teleprompter window stays. It doesn't disappear behind whatever app is in focus.

It follows your voice. You don't have to control the scroll manually. As you talk through your pitch, the script scrolls. When you pause to answer a question, it pauses. When you get back to your script, it's waiting on the right line.

The voice recognition is on-device (Apple's native speech recognition), so nothing is processed on a server. On a confidential sales call, that matters.

## How to Structure a Demo Call Script
...
Positioning your teleprompter close to the camera helps with this. If your notes are near the lens, your eyes drift only slightly when you reference them.

For more on this specifically, [how to look confident on camera](./how-to-look-confident-on-camera.md) covers the full technique.
